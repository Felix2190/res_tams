...
<head>
    ...
    <title>Asigna tramite <?php echo $etapaConfigurada; ?></title>
            ...
            <div id="content" class="clearfix">
                <header id="header-sec">
                	<div class="inner-padding">
                        <div class="pull-left">
                            <h2><i class="fa fa-check-circle-o "></i> &nbsp;&nbsp;Asigna Tramite </h2>
                        </div>
                    </div>
            	</header>
                    ...
                    <div class="inner-padding form-horizontal"> 
 								<div class="col-sm-12">	    
										...
										<div class="row">
	                                        ...
	                                        <div class="form-group"> 
	                                        	...
	                                        	<label class="col-sm-2 control-label txtTurno" for="txtTurno"> Turno </label>
	                                        	<div class="col-sm-3">
													<input id="txtTurno" name="txtTurno"
												...
												<div class="col-sm-3">
													<button class="btn btn-primary" id="btnConsultarTurno" name="btnConsultarTurno"> Buscar</button>
                                        ...
                                        <div class="form-group">                                        	
                                        	<label class="col-sm-2 control-label txtNombre" for="txtNombre" > Nombre </label>
                                        	<div class="col-sm-8">
												<input id="txtNombre" name="txtNombre"
													class="form-control text-uppercase txtNombre" type="text" maxlength="50" value="" readonly/>
											</div>
									...
									<div class="row">
                                        ...
                                        <div class="form-group">                                        	
                                        	<label class="col-sm-2 control-label txtTurnoInt" for="txtTurnoInt" > Turno Interno </label>
                                        	<div class="col-sm-3">
												<input id="txtTurnoInt" name="txtTurnoInt"
													class="form-control txtTurnoInt " type="text" maxlength="50" readonly/>
											</div>  
											                          	
                                                                            	
                                        	<label class="col-sm-2 control-label txtTurnoExt" for="txtTurnoExt"> Turno Externo </label>
                                        	<div class="col-sm-3">
												<input id="txtTurnoExt" name="txtTurnoExt"
													class="form-control txtTurnoExt" type="text" maxlength="50" readonly/>
											</div>  
											<div class="spacer-5"></div>                          	
                                        </div>
                                     </div>  
                                     <div class="row">
                                        ...
                                        <div class="form-group">                                        	
                                        	<label class="col-sm-2 control-label txtFecha" for="txtFecha"> Fecha Hora </label>
                                        	<div class="col-sm-3">
												<input id="txtFecha" name="txtFecha"
													class="form-control txtFecha" type="text" maxlength="50" readonly/>
											</div>  
								...
								<div class="spacer-20"></div>
    	                         ...
    	                         <table class="table" id="tablesorting-1" >
                                        ...
                                        <div class="spacer-20"></div>
                                        <input type="hidden" id="txtIdTurno" name="txtIdTurno" value="">
    	                                  		<div class="col-sm-12">
    	                                        	<div class="spacer-20"></div>
                                                    	<div class="col-sm-12">
                                                    		<div class="pull-right">
                                                    			
																<button class="btn btn-success" id="btnAsignaTramite" name="btnAsignaTramite"> Asignar</button>
