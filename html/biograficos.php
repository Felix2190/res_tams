...
<body>
	<div id="container" class="clearfix">
		<aside id="sidebar-main" class="sidebar">            
          ...
          <?php
            $modulo_activo = 3;
            $pagina_activa = 'biograficos_generales';
...
<!--							<div class="row">
	...
	-->							
							...
							<div class="row">
								...
								<div class="col-sm-4">
								<input id="txtNacimiento" name="txtNacimiento" class="form-control" type="text" value="<?php echo $datosTab1['fechaNac'];?>"/>
								</div>
							</div>
						...
						<div class="spacer-10"></div>
							...
							<div class="row">
								<div class="col-sm-3 text-right">
									<label class="control-label txtCorreoE"
										for="txtCorreoE"> Correo Electr&oacute;nico </label>
								</div>
								<div class="col-sm-7">
							...
							<fieldset>
  							...
  							<div class="row">
  								...
  								<div class="col-sm-5">
    								<div class="col-sm-3">
    								<input id="txtCodPais" class="form-control txtCodPais numeric2" maxlength="3" value="<?php echo $datosTab2['codPais'];?>" />
		...
		<!-- 					
			 ...
			 -->				
							...
							<div class="row">
								...
								<div class="col-sm-7">
													<input type="text" class="form-control"
														...
														maxlength="50"
														value="<?php echo $datosTab3['extras'];?>" />
								</div>
							</div>
							<div class="spacer-10"></div>
							...
							<div class="row">
									...
									<div class="col-sm-4">
                    <select class="form-control" name="donador" id="donador">
                      ...
                      <option <?php if($datosTab3['donador']==0){ echo 'selected="selected"'; } ?> value="0">No</option>
							...
							<div class="row">
								...
								<input  id="txtApellidoPaternoContacto" name="txtApellidoPaternoContacto"
														class="form-control" type="text" maxlength="50" value="<?php echo $datosTab4['apellidoP'];?>"/>
								</div>
							</div>
							<div class="spacer-10"></div>
							...
							<div class="row">
								...
								<div class="col-sm-5">
								<div class="col-sm-2">
								<input id="txtCodPaisCont" class="form-control txtCodPaisCont" maxlength="3" value="<?php echo $datosTab4['codPais'];?>" />
								<div class="helper-text-box"><p>C&oacute;digo de pa&iacute;s</p></div>
								</div>
								<div class="col-sm-1">
								<label>-</label>
								...
								<div class="col-sm-2">
								<input id="txtLadaCont" class="form-control txtLadaCont" maxlength="3" value="<?php echo $datosTab4['lada'];?>" />
								<div class="helper-text-box"><p>Lada</p></div>
								</div>
								<div class="col-sm-1">
								<label>-</label>
								...
								<div class="col-sm-4">
								<input id="txtTelCont" class="form-control txtTelCont" maxlength="8" value="<?php echo $datosTab4['telCasa'];?>" />
								<div class="helper-text-box"><p>N&uacute;mero</p></div>
								</div>
								</div>
							</div>
