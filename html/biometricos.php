...
<head>
    ...
    <title>Biom&eacute;tricos</title>
            ...
            <div id="content" class="clearfix">
                ...
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                            <h2>Captura de biom&eacute;tricos</h2>                 
                        </div> 
                    </div>
            	</header>                                     
                 <div class="window">  
                    <!-- <div class="row ext-raster"> -->
                   	<!-- <div class="col-sm-12"> -->
                            <!-- <div class="row"> -->
								...
								<div class="widget" id="widBio" style="display: none;">
                                    <header>
                                    	<h2>Biom&eacute;ticos</h2>                                 
                                    </header>
                                    <div>
                                        <ul class="ext-tabs">
                                            <li class="active">
                                                <a href="#content-tab-50-a " id="tabDedo">Huellas</a>
                                            </li>
                                            <li>
                                                <a href="#content-tab-50-b" id="tabOjo">Iris</a>
                                            </li>
                                            <li>
                                                <a href="#content-tab-50-c " id="tabRostro">Rostro</a>
                                            </li> 
                                        </ul>
                                        <div class="tab-content">
                                            <div id="content-tab-50-a" class="tab-pane active" >
                                                <div class="inner-padding" id="divCapturaH" style="display: none;">
                                                     
                                                </div>
                                            </div>
                                            <div id="content-tab-50-b" class="tab-pane">
                                                <div class="inner-padding" id="divCapturaI" style="display: none;">
                                               </div>
                                            </div>
                                            <div id="content-tab-50-c" class="tab-pane">
                                                <div class="inner-padding" id="divCapturaR" style="display: none;">
