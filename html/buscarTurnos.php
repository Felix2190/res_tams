            ...
            <div id="content" class="clearfix">
                <header id="header-sec">
                	<div class="inner-padding">
                        <div class="pull-left">
                            <h2><i class="fa fa-search "></i> &nbsp;&nbsp;Buscar Turno </h2>
                        </div>
                    </div>
            	</header>
                 ...
                 <div class="window">
                    ...
                    <div class="inner-padding form-horizontal"> 
 								<div class="col-sm-12">	    
										...
										<div class="row">
	                                        <div class="form-group"> 
	                                        	<label class="col-sm-2 control-label txtTurnoInt" for="txtTurnoInt">ID Turno</label>
	                                        	<div class="col-sm-4">
													<input id="txtTurnoInt" name="txtTurnoInt"
														class="form-control text-uppercase txtTurno" type="text" maxlength="50" value="" />
												</div>
									
	                                        	<label class="col-sm-2 control-label txtTurnoExt" for="txtTurnoExt"> Turno</label>
	                                        	<div class="col-sm-4">
													<input id="txtTurnoExt" name="txtTurnoExt"
														class="form-control text-uppercase txtTurnoExt" type="text" maxlength="50" value="" />
												</div>
												</div>
											</div>
										<div class="row">
	                                        <div class="form-group"> 		
												<label class="col-sm-2 control-label slcTipo" for="slcTipo"> Tipo</label>
	                                        	<div class="col-sm-4">
													
													<select id="slcTipo" class="form-control">
														<option value="">Seleccione una opci&oacute;n</option>
														<option value="imcompleto" selected>Incompleto</option>
														<option value="terminado">Terminado</option>
			
													</select>
												</div>
												
												<label class="col-sm-2 control-label txtFechaMovimiento" for="txtFechaMovimiento"> Fecha Ult. Mov.</label>
											 	<div class="col-sm-4">
	                                        		<input id="txtFechaMovimiento" name="txtFechaMovimiento"
										...
										<div class="row">
	                                        ...
	                                        <div class="form-group">                                        	
	                                        	<label class="col-sm-2 control-label txtNombre" for="txtNombre" > Nombres </label>
	                                        	<div class="col-sm-10">
													<input id="txtNombre" name="txtNombre"
														class="form-control text-uppercase txtNombre" type="text" maxlength="50" value="" />
												</div>
											</div>                          	
	                                 </div>
									...
									<div class="row">
	                                        ...
	                                        <div class="form-group"> 	 		
												<label class="col-sm-2 control-label txtApPat" for="txtNombre" > Apellido Paterno </label>
	                                        	<div class="col-sm-4">
													<input id="txtApPat" name="txtApPat"
														class="form-control text-uppercase txtNombre" type="text" maxlength="50" value="" />
												</div>  
												
												<label class="col-sm-2 control-label txtApPat" for="txtApMat" > Apellido Materno </label>
	                                        	<div class="col-sm-4">
													<input id="txtApMat" name="txtApPat"
														class="form-control text-uppercase txtApMat" type="text" maxlength="50" value="" />
												</div>                          	
	                                        </div>
										...
										<div class="row">
	                                        <div class="form-group"> 
	                                        	<label class="col-sm-2 control-label txtCURP" for="txtCURP"> CURP</label>
	                                        	<div class="col-sm-4">
													<input id="txtCURP" name="txtCURP"
														class="form-control text-uppercase txtCURP" type="text" maxlength="50" value="" />
												</div>
								...
								<div class="col-sm-12">
                                          ...
                                          <div class="col-sm-12">
                                               <div class="pull-right">
												...
												<button class="btn btn-primary" id="btnBuscar" name=""btnBuscar""> Buscar </button>
	                                      		</div>
                                      	</div>
    	                         </div>
								<div class="spacer-20"></div>
