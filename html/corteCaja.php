            ...
            <div id="content" class="clearfix">
                ...
                <header id="header-sec">
                	<div class="inner-padding">
                        <div class="pull-left">
                            <h2>Corte Caja <?php echo date("d/m/Y")?></h2>
                        </div>
                    </div>
            	</header>
                            ...
                            <div class="row">
                            	<div class="col-sm-12">
                                    <div class="inner-padding">
                                    	...
                                    	<div class="row">
                                    		<div class="col-sm-12">
                                    			<table class="table table-striped" id="tablesorting-1">
												<thead>
													<tr>
                                    	...
                                    	<div class="row">
                                    		<div class="col-sm-12">
                                    			<button class="btn btn-primary" id="btnCorte">Realizar Corte de Caja</button>
                                    			<a class="btn btn-default" href="exportCorteCSV.php" target="_blank">Exportar Datos CSV</a>
                                    		</div>
                                    	</div>
