            ...
            <div id="content" class="clearfix">
                <header id="header-sec">
                	<div class="inner-padding">
                        <div class="pull-left">
                            <h2><i class="fa fa-check-circle-o "></i> &nbsp;&nbsp;Generar turnos para <?php echo $strubicacion;?></h2>
							<input type="hidden" id="idUbicacion" value="<?php echo $idubicacion;?>"/>
                        </div>
                    </div>
            	</header>
                 ...
                 <div class="window">
                    ...
                    <button class="btn btn-success btn-lg" id="btnCrearTurno" name="btnCrearTurno"> Generar turno </button>
