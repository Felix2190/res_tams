...
<head>
    ...
    <title>Aplicaci&oacute;n de Ex&aacute;menes</title>
            ...
            <div id="content" class="clearfix">                
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                            <h2>Licencia tipo <?php echo $tipoLicencia .' No. ' .$numero;?></h2>                 
                        </div> 
                    </div>
            	</header>                                     
                 <div class="window">  
                   	...
                   	<!-- <div class="col-sm-12"> -->
                            <!-- <div class="row"> -->
                            	<div class="col-sm-12">
									...
									<div class="widget">
														<header>
                            				<h2><i class="fa fa-gears text-muted"></i>Ex&aacute;menes disponibles para <?php echo $tipoLicencia ?></h2>
                            				</header>
