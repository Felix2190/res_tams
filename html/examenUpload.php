...
// $subnav = 'home';
// $nav='';
	$__pasoActual="examen";  //turno, tramite, pago, datos, documentos,verificacion, examen, impresion
		...
		<div id="main" class="clearfix">       
            ...
            <div id="content" class="clearfix">
				...
				<header id="header-sec">
					<div class="inner-padding">
						<div class="pull-left">
							<h2>Certificado de Manejo para <?php  echo $persona->getNombres().' '.$persona->getPrimerAp().' '.$persona->getSegundoAp() ; ?></h2>
						</div>
					</div>
				</header>
                ...
                <div class="window">  
                    <div class="row ext-raster">
                    	<div class="col-sm-12">
                          ...
                          <input type="hidden" id="txtIdTurno" name="txtIdPersona" value="<?php echo $objTurno->getIdTurno()?>">
													...
													<div class="col-md-12">
														...
														<div class="col-sm-12">
															...
															<div class="form-group">
																<div class="row">
																	<input type="button" id="btnDigitalizar" value="Digitalizar" onclick="AcquireImage(DWObject,'');" class="btn btn-default" />
																	<input type="button" id="btnCargar" value="Cargar" onclick="LoadImages(DWObject,'');" class="btn btn-default" />
																	<input type="button" id="btnBorrar" value="Borrar" onclick="DeletImage(DWObject,'');" class="btn btn-default disabled" />
																</div>
																<div class="row">
																	<div id="dwtcontrolContainer">Previsualizar</div>
																</div>
															</div>
								...
								<div class="col-sm-2">
									<button class="btn btn-default" id="btnCancelar" onclick="location.href='listadoExamen.php?idEtapa=9';"  href="listadoExamen.php"
