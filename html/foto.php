...
<script src="js/system/script/fotografia.js"></script>    
            ...
            <div id="content" class="clearfix">
				<header id="header-sec">
					<div class="inner-padding">
						<div class="pull-left">
							<h2><i class="fa fa-camera" aria-hidden="true"></i> &nbsp;Fotografia </h2>
						</div>
					</div>
				</header>
                                    ...
                                    <div class="inner-padding">								
										<div class="row">
											...
											<div class="col-sm-4 panel panel-primary">
												<div class="row">
													<div id="video-container" class="video-container" style="width: 100%; height: 200px;"></div>
												</div>
												<div class="row">
											...
											<div class="col-sm-4 panel panel-primary">
												<div class="row">
													<div id="image-container" style="width: 100%; height: 200px; border-style:none"></div>
												</div>
										...
										<div class="row">
											...
											<div class="col-sm-4 text-center">
												<button type="button" class="btn btn-primary" name="btnFoto" id="btnFoto">Tomar Foto</button>
											</div>	
											<div class="col-sm-1">
													&nbsp;
											</div>
											<div class="col-sm-2 text-center">
												<button type="button" class="btn btn-default" name="btnLimpiar" id="btnLimpiar">Limpiar</button>
											</div>
													
											<div class="col-sm-2 text-center">
												<button type="button" class="btn btn-success" name="btn-upload" id="btn-upload">Guardar</button>
											</div>
											<div class="col-sm-1">
													&nbsp;
											</div>
