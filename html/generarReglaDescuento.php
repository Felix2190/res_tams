            ...
            <div id="content" class="clearfix">
                ...
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                            <h2>Generar Regla de Descuento</h2>                 
                        </div> 
                    </div>
            	</header>
                          ...
                          <div class="inner-padding ">	
                            ...
                            <div class="spacer-20"></div>
            								<div class="form-group">
            									...
            									<div class="col-sm-9">
            										<input id="txtDescripcion" class="form-control" type="text" maxlength="50" />
            									</div>
            								</div>                            
                            <div class="spacer-20"></div>
            								<div class="form-group">
            									...
            									<div class="col-sm-9">
            										<input id="txtEdadMinima" class="form-control" type="number" />
            									</div>
            								</div>
                            <div class="spacer-20"></div>
                            <div class="form-group">
            									...
            									<div class="col-sm-9">
            										<input id="txtEdadMaxima" class="form-control" type="number" />
            									</div>
            								</div>   
                            <div class="spacer-20"></div>
                            <div class="form-group">
            									...
            									<div class="col-sm-9">
            										<input id="txtCantidad" class="form-control" type="number" />
            									</div>
            								</div>   
                            <div class="spacer-20"></div>
            								<div class="form-group">
            									...
            									<div class="col-sm-9">
            										<input id="esPorcentaje" class="form-control" type="checkbox" /> Si
            									</div>
            								</div>
                            <div class="spacer-20"></div>            								
            								<div class="form-group">
            									...
            									<div class="col-sm-9">
            										<select id="slcTipoLicencia" class="form-control"><?php echo $reglaDescuento->getListadoTipoTramitesSelect(); ?></select>
            									</div>
            								</div>
        										<div class="row">
