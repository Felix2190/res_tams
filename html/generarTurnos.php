<?php
	...
	$__pasoActual="turno";  //turno, tramite, pago, datos, documentos,verificacion, examen, impresion
...
<head>
    ...
    <title>Identificar Persona <?php echo $etapaConfigurada; ?></title>
                    ...
                    <div class="inner-padding form-horizontal"> 
 								<div class="col-sm-12">	    
										...
										<div class="form-group col-sm-2">
											<label for="inputdefault">Turno disponible</label>
										</div>
										<div class="col-sm-3">
											<input class="form-control input-lg" id="txtTurnoActual"  name="txtTurnoActual" type="text" 
											style="font-size: 35px; text-align: center; height: 50px;" disabled value="<?php echo $strUltimoTurno; ?>">
										</div>  
										<div class="col-sm-1">
											<button class="btn btn-default" id="btnAtender" name="btnAtender"> Atender </button>
										</div>
										<div class="col-sm-1">
											<button class="btn btn-default" id="btnSiguienteTurno" name="btnSiguienteTurno"> Siguiente turno </button>
										</div>
