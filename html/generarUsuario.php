                          ...
                          <div class="inner-padding ">	
                            ...
                            <div class="spacer-20"></div>
            								<div class="form-group">
            									...
            									<div class="col-sm-9">
                                <select id="slcRecaudacion" class="form-control"><?php echo $recaudacion->getListadoUbicacionSelect(); ?></select>
            									</div>
            								</div> 
                            <div class="spacer-20"></div>
            								<div class="form-group">
            									...
            									<div class="col-sm-9">
                                <select id="slcRol" class="form-control"><?php echo $rol->getListadoRolesSelect(); ?></select>
            									</div>
            								</div> 
                            <div class="spacer-20"></div>
