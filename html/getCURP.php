...
<div id="content" class="clearfix">
                <header id="header-sec">
                	<div class="inner-padding">
                        <div class="pull-left">
                            <!--  <h2><i class="fa fa-plus"></i> &nbsp;&nbsp;Consultar CURP </h2>-->
                            <label id="lblMensaje">Espere mientras carga la ventana de consulta de CURP..</label>	
                        </div>
                    </div>
            	</header>
                 ...
                 <div class="window">
                    <div class="col-sm-12">
		                ...
		                <iframe id="fram1" id="fram1" name="fram1" height="600" marginheight="5" src="http://consultas.curp.gob.mx/CurpSP/inicio2_2.jsp" frameborder="0" width="100%" name="indice" marginwidth="5" scrolling="no">   
