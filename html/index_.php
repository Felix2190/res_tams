				...
				<div class="box-login">
						...
						<fieldset>
							...
							-->
								...
								<div class="form-group">
								<a href="indexInt.php" class="btn btn-primary pull-left" > Usuario Interno <i class="fa fa-arrow-circle-right"></i></a>
								</div>
								...
								<div class="form-group">
								<a href="indexExterno.php" class="btn btn-primary pull-left" > Usuario Externo <i class="fa fa-arrow-circle-right"></i></a>
								</div>
