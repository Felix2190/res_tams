...
//		 alert(txtIdTurno);
		...
		var txtEmail = $("#txtApellidoMaterno").val().trim();
		if (txtApellidoMaterno == "") {
			existeError = true;
			console.log("Error: txtApellidoMaterno");
			$(".txtApellidoMaterno").removeClass("isOk");
...
//			rfc =calcula(txtApellidoPaterno,txtApellidoMaterno,txtNombres,txtNacimiento.substr(2, 2)+txtNacimiento.substr(5, 2)+txtNacimiento.substr(8, 2))
		...
		var estatura = $("#txtEstatura").val().trim();
		if (estatura == "") {
			existeError = true;
			console.log("Error: txtEstatura");
			$(".txtEstatura").removeClass("isOk");
			$(".txtEstatura").addClass("isError");
		} else {
			$(".txtEstatura").removeClass("isError");
		}    
    
    var donador = $('#donador').val();
    ...
    var txtApellidoPaternoContacto = $("#txtApellidoPaternoContacto").val().trim();
		if (txtApellidoPaternoContacto == "") {
			existeError = true;
			console.log("Error: txtApellidoPaternoContacto");
			$(".txtApellidoPaternoContacto").removeClass("isOk");
			$(".txtApellidoPaternoContacto").addClass("isError");
		} else {
			$(".txtApellidoPaternoContacto").removeClass("isError");
		}

    var txtApellidoMaternoContacto = $("#txtApellidoMaternoContacto").val().trim();
		if (txtApellidoMaternoContacto == "") {
			existeError = true;
			console.log("Error: txtApellidoMaternoContacto");
			$(".txtApellidoMaternoContacto").removeClass("isOk");
			$(".txtApellidoMaternoContacto").addClass("isError");
		} else {
			$(".txtApellidoMaternoContacto").removeClass("isError");
		}
    
		var txtCodPaisCont = $("#txtCodPaisCont").val().trim();
		if (txtCodPaisCont == "") {
			existeError = true;
			console.log("Error: txtCodPaisCont");
			$(".txtCodPaisCont").removeClass("isOk");
			$(".txtCodPaisCont").addClass("isError");
		}  else if(txtCodPaisCont.length<2){
			existeError = true;
			$(".txtCodPaisCont").removeClass("isOk");
			$(".txtCodPaisCont").addClass("isError");
			mostrarError("El Codigo Pais debe contener 2 digitos.");
			...
			$(".txtCodPaisCont").removeClass("isError");
		}
		
		var txtLadaCont = $("#txtLadaCont").val().trim();
		if (txtLadaCont == "") {
			existeError = true;
			console.log("Error: txtLadaCont");
			$(".txtLadaCont").removeClass("isOk");
			$(".txtLadaCont").addClass("isError");
		}  else if(txtLadaCont.length<3){
			existeError = true;
			$(".txtLadaCont").removeClass("isOk");
			$(".txtLadaCont").addClass("isError");
			mostrarError("La Lada debe contener 3 digitos.");
			...
			$(".txtLadaCont").removeClass("isError");
		}
		
		var txtTelCont = $("#txtTelCont").val().trim();
		if (txtTelCont == "") {
			existeError = true;
			console.log("Error: txtTelCont");
			$(".txtTelCont").removeClass("isOk");
			$(".txtTelCont").addClass("isError");
		}  else if(txtTelCont.length<7){
			existeError = true;
			$(".txtTelCont").removeClass("isOk");
			$(".txtTelCont").addClass("isError");
			mostrarError("El número de teléfono debe contener 10 digitos.");
			...
			$(".txtTelCont").removeClass("isError");
		}
      ...
      return false;
		...
		if(mailError){
			...
			xajax_guardarTab1(txtApellidoPaterno,txtApellidoMaterno,txtNombres, txtNombre2, txtNacimiento,slcGenero,slcNacionalidad ,txtCorreoE, txtIdTurno);      
		  xajax_guardarTab2(slcEstado ,slcMunicipioDom,slcLocalidad,slcColonia,txtCalle ,txtNumExt, txtNumInt ,txtCP ,txtCodigoPais, txtLada,txtTelefono ,txtTelefonoMobil ,txtIdTurno);			
			xajax_guardarTab3(slcColorOjos ,slcTipoSandre, estatura, txtPesoKG, txtSenas,donador,txtIdTurno);
			xajax_guardarTab4(txtNombreContacto ,txtApellidoPaternoContacto ,txtApellidoMaternoContacto, txtCodPaisCont, txtLadaCont ,txtTelCont,txtIdTurno);
...
//  $('#txtNacimiento').mask("00/00/0000", {placeholder: "__/__/____"});
	/*
