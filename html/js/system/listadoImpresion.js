var callback;
var imprimir =function (idTurno)
	{
	   mostrarEspera('Procesando solicitud...');
       getIPs(function(ip){xajax_imprimirLicencia(idTurno,ip);});
     // xajax_imprimirLicencia(idTurno,ip);
    
  	 }

var  styleTabla=function(datos){
    $("#divListado").html(datos);
    $("#tablesorting-1").dataTable();
        //"class": "table"});
    }
