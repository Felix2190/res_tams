var inicializarControles=function()
	...
	var ficha = "<html><head><title></title>\	<style>	\	table {		width: 100%;	}		\	.table-striped, table.table-striped td, table.table-striped th,td,th {"+    
			...
			"border: 1px solid black;		} header { border: 1px solid #bbb; \ background-color: lightgrey;} .spacer-20{height: 20px;} tr.border_bottom td, tr.border_bottom th{border-bottom: 1px solid #bbb; } tr.separador td, tr.separador th{border-bottom: 1px solid #fff; }tr.bg{background-color: #bbb;}</style> \	</head><body><table> "+
