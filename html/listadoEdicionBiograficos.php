...
<head>
    ...
    <title>Listado Datos- Modulo I</title>
            ...
            <div id="content" class="clearfix">
                ...
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                             <h2><i class="fa fa-sort-alpha-asc"></i>  &nbsp;Listado Turnos Edición</h2> 
                        </div>
                    </div>
            	</header>
                ...
                <div class="window">
                	...
                	<div class="actionbar">
                        <div class="pull-right">
                            <a class="btn" href="generarTurnos.php">
                            	<i class="fa fa-plus"></i> Agregar Turno <?php 
                            	global $objSession;
                            	echo $objSession->getIdUbicacion();?>
                        	</a>                        
                        </div>  
                    </div>
