...
//	echo date('Y-m-d');
	//clean Ticket ID
        $__pasoActual="impresion";  //turno, tramite, pago, datos, documentos,verificacion, examen, impresion
        ...
        <div id="main" class="clearfix">       
            ...
            <div id="content" class="clearfix">        
                ...
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                                <h2><i class="fa fa-stack-exchange"></i> &nbsp;&nbsp;Listado de licencias para impresi&oacute;n</h2>                 
                        </div> 
                    </div>
            	</header>                                     
                 <div class="window">
