...
//	require 'admintickets.php';
  ...
  // Para obtener licencias vigentes
  $licencias = $reglaLicencia->getLicenciasVigentesByPersona(29);
  $prueba = $reglaLicencia->getLicenciasTurnosVigentesByPersona(29);   
  echo $prueba.'testes';    */
            ...
            <div id="content" class="clearfix">                
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                                <h2><i class="fa fa-stack-exchange"></i> &nbsp;&nbsp;Reglas Licencia</h2>                 
                        </div> 
                    </div>
            	</header>                                     
                 <div class="window">
              ...
              <input type="hidden" id="p" value="<?php echo $permisos_reglas; ?>" />              
							<table class="table" id="tablesorting-1">
											...
											<tbody>
												<?php echo $reglaLicencia->getListadoReglas(); ?>
											</tbody>
											<tfoot>
												<tr>
