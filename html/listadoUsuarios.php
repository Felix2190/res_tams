            ...
            <div id="content" class="clearfix">                
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                                <h2><i class="fa fa-stack-exchange"></i> &nbsp;&nbsp;Usuarios</h2>                 
                        </div> 
                    </div>
            	</header>                                     
                 <div class="window">
              ...
              <input type="hidden" id="p" value="<?php echo $permisos_usuarios; ?>" />
							<table class="table" id="tablesorting-1">
											...
											<tbody>
												<?php echo $login_user->getListadoUsuarios(); ?>
											</tbody>
											<tfoot>
												<tr>
