            ...
            <div id="content" class="clearfix">
                ...
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                            <h2><i class="fa fa-globe"></i> &nbsp; POA</h2>                 
                        </div> 
                    </div>
            	</header>
...
FROM (
	...
	OR CONVERT(char(10),FromDate,120)  BETWEEN  CONVERT(char(10),DATEADD (yyyy,-1,CAST(@fini AS DATETIME)),120) AND CONVERT(char(10),DATEADD (yyyy,-1,CAST( @ffin AS DATETIME)),120))
	) AS lic
INNER JOIN 
	(
	...
	WHERE (CONVERT(char(10),cms_hora,120)  BETWEEN @fini AND @ffin
		OR CONVERT(char(10),cms_hora,120)  BETWEEN  CONVERT(char(10),DATEADD (yyyy,-1,CAST(@fini AS DATETIME)),120) 
		AND CONVERT(char(10),DATEADD (yyyy,-1,CAST( @ffin AS DATETIME)),120))
