...
//	require 'admintickets.php';
  ...
  $recaudacion->setIdUbicacion($_POST['id']);    
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Alta recaudaci&oacute;n</title>
            ...
            <div id="content" class="clearfix">
                ...
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                            <h2>Editar Recaudaci&oacute;n</h2>                 
                        </div> 
                    </div>
            	</header>
                          ...
                          <div class="inner-padding ">	
                            ...
                            <input type="hidden" value="<?php echo $_POST['id']; ?>" id="id" />          
            								<div class="form-group">
            									...
            									<div class="col-sm-9">
            										<input id="txtNombre" class="form-control" type="text" value="<?php echo $recaudacion->getNombre(); ?>"
            											maxlength="50" />
            									</div>
            								</div>
                            ...
                            <div class="spacer-20"></div>
            								<div class="form-group">
            									...
            									<div class="col-sm-9">
            										<input id="estatus" class="form-controles" type="checkbox" <?php if($recaudacion->getEstatus()=='activa'){ echo 'checked="checked"'; } ?> <?php if($permisos_recaudacion<8){ echo 'disabled="disabled"'; } ?> />
            									</div>
            								</div>                             
        										<div class="row">
