...
<!-- 										</div> -->
										...
										<div id="datosInventario">
											...
											<div class="col-sm-6">
												<select id="salida" name="salida" class="form-control"  >
												<option value="">Seleccione una opci&oacute;n</option>
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												...
												<option value="paqueteria">Envio por paqueter&iacute;a</option>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input id="personaRecibe" name="personaRecibe" class="form-control" type="text" />
												</div>
											</div>
											
											<div id="paq" class="form-group">
												<label class="col-sm-4 control-label" for="planName">
													 Paqueter&iacute;a
												</label>
												<div class="col-sm-6">
													<input id="paqueteria" name="paqueteria" class="form-control" type="text" />
												</div>
											</div>																									
											<div id="noGuia" class="form-group">
												<label class="col-sm-4 control-label" for="planName">
													 Numero de gu&iacute;a
												</label>
												<div class="col-sm-6">
											...
											<div id="especifique" class="form-group">
												<label class="col-sm-4 control-label" for="planName">
													 Especifique
												</label>
												<div class="col-sm-6">
													<input id="especifiques" name="especifiques" class="form-control" type="text" />
												</div>
											</div>			
