                                    ...
                                    <div class="subheading">
	 								...
	 								<div class="inner-padding form-horizontal"> 									
										...
										<ul class="ext-tabs" id="myTab4">
											...
											<li>
												<a data-toggle="tab" href="#panel_billing">
													Traspaso recepci&oacute;n
												</a>
											</li>
										</ul>
									<div class="tab-content ext-tabs-boxed">
											<div id="panel_contact" class="tab-pane  in active">
 									...
 									<div class="form-group">
										 ...
										 <div class="spacer-20"></div>
										  ...
										  <div class="form-group">
											...
											<div class="col-sm-6">
												<select id="UbicacionNueva" name="UbicacionNueva" class="form-control"  >
												<?php echo $slcUbicaciones ;?>>
												</select>
											</div>
										</div>																		
											...
											<div class="col-sm-6">
												<input id="codigo" name="codigo" placeholder="Teclea 2 caracteres para iniciar la busqueda." class="form-control"  type="text" />
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input id="numeroSerie" name="numeroSerie" placeholder="Teclea 2 caracteres para iniciar la busqueda." class="form-control"  type="text" />
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input id="mac" name="mac" class="form-control" placeholder="XX:XX:XX:XX:XX:XX" maxlength = 17 type="text" />
												</div>
											</div>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">									
												<button id="btnGuardar" class="btn btn-wide btn-success" > Guardar Datos</button>
											</div>
										</div>
...
<!-- ///////////////////////segunda pastaña -->
											<div id="panel_billing" class="tab-pane fade">
											<div class="spacer-20"></div>
											...
											<input type="hidden" id="idalmacenT" name="idalmacen" value="">
											<div class="col-sm-6">
												<input id="folioT" name="folioT"  class="form-control"  type="text"/>
											</div>
										</div>
											<div class="form-group">
												<label class="col-sm-4 control-label" for="planName">
												...
												<div class="col-sm-6">
													<input id="fechaT" name="fechaT" placeholder="AAAA-MM-DD" class="form-control"  type="text" />
												</div>
											</div>
											<div class="spacer-20"></div>										  
										  <div class="form-group">
											...
											<div class="col-sm-6">
												<select id="UbicacionT" name="UbicacionT" class="form-control"  disabled="disabled">												
												<?php echo $slcUbicaciones ;?>>
												</select>
											</div>
										</div>
										 ...
										 <div class="spacer-20"></div>										  
										  <div class="form-group">
											...
											<div class="col-sm-6">
												<select id="UbicacionNuevaT" name="UbicacionNuevaT" class="form-control"  >												
												<?php echo $slcUbicaciones ;?>>																				 -->
												</select>
											</div>
										</div>																			
											...
											<div class="col-sm-6">
												<input id="codigoT" name="codigoT" placeholder="" class="form-control"  type="text" disabled="disabled" />
											</div>											
										</div>										
										...
										<div id="datosInventario">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input id="numeroSerieT" name="numeroSerieT" placeholder="" class="form-control"  type="text" disabled="disabled"/>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input id="macT" name="macT" class="form-control" placeholder="XX:XX:XX:XX:XX:XX" maxlength = 17 type="text" disabled="disabled"/>
												</div>
											</div>
											</div>
																						...
																						<div class="form-group">
											<label class="col-sm-4 control-label" for="planName">
												Comentarios de traslado
											</label>
											<div class="col-sm-6">
												<textarea id="comentariosTa" name="comentariosTa" rows="10" cols="50" disabled="disabled">
												</textarea>
											</div>
											
											<div class="form-group">
											<label class="col-sm-4 control-label" for="planName">
												Comentario de recepci&oacute;n
											</label>
											<div class="col-sm-6">
												<textarea id="comentariosT" name="comentariosT" rows="10" cols="50">
												</textarea>
											</div>
...
<!-- 												<input type="button" class="btn btn-success" name="btnGuardar" id="btnGuardarT" value="Guardar" /> -->
											</div>
										</div>
										...
										<div class="form-group">
											<div class="col-sm-4">&nbsp;</div>
											<div class="col-sm-8">									
												<button id="btnGuardarT" class="btn btn-wide btn-success" > Guardar Datos</button>
											</div>
										</div>
