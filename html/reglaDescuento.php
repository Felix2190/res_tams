...
//	require 'admintickets.php';
  ...
  $reglaDescuento->setIdReglaDescuento($_POST['id']);
?>
<!DOCTYPE html>
                          ...
                          <div class="inner-padding ">	
                            ...
                            <input type="hidden" value="<?php echo $_POST['id']; ?>" id="id" />          
            								<div class="form-group">
            									...
            									<div class="col-sm-9">
            										<input id="txtNombre" class="form-control" type="text" value="<?php echo $reglaDescuento->getNombre(); ?>" maxlength="50" />
            									</div>
            								</div>
                            <div class="spacer-20"></div>
            								<div class="form-group">
            									<label class="col-sm-3 control-label txtDescripcion"
            										for="txtDescripcion"> Descripci&oacute;n </label>
            									<div class="col-sm-9">
            										<input id="txtDescripcion" class="form-control" type="text" value="<?php echo $reglaDescuento->getDescripcion(); ?>" />
            									</div>
            								</div>
                            <div class="spacer-20"></div>               								
            								<div class="form-group">
            									<label class="col-sm-3 control-label txtEdadMinima"
            										for="txtEdadMinima"> Edad M&iacute;nima </label>
            									<div class="col-sm-9">
            										<input id="txtEdadMinima" class="form-control" type="number" value="<?php echo $reglaDescuento->getEdadMenor(); ?>" />
            									</div>
            								</div>
                            <div class="spacer-20"></div>
                            <div class="form-group">
            									<label class="col-sm-3 control-label txtEdadMaxima"
            										for="txtEdadMaxima"> Edad M&aacute;xima </label>
            									<div class="col-sm-9">
            										<input id="txtEdadMaxima" class="form-control" type="number" value="<?php echo $reglaDescuento->getEdadMayor(); ?>" />
            									</div>
            								</div>
                            <div class="spacer-20"></div> 
                            <div class="form-group">
            									<label class="col-sm-3 control-label txtCantidad"
            										for="txtCantidad"> Cantidad </label>
            									<div class="col-sm-9">
            										<input id="txtCantidad" class="form-control" type="number"  value="<?php echo $reglaDescuento->getCantidad(); ?>" />
            									</div>
            								</div>                                 
                            <div class="spacer-20"></div>
            								<div class="form-group">
            									<label class="col-sm-3 control-label esPorcentaje"
            										for="esPorcentaje"> ¿Es Porcentaje? </label>
            									<div class="col-sm-9">
            										<input id="esPorcentaje" class="form-control" type="checkbox" <?php if($reglaDescuento->getEsPorcentaje()==1){ echo 'checked="checked"'; } ?> />¿Obligatorio?
            									</div>
            								</div>
                            <div class="spacer-20"></div>
            								<div class="form-group">
            									...
            									<div class="col-sm-9">
            										<select id="slcTipoLicencia" class="form-control"><?php echo $reglaDescuento->getListadoTipoTramitesSelect($reglaDescuento->getIdTipoLicencia()); ?></select>
            									</div>
            								</div>
                            <div class="spacer-20"></div>                            
            								<div class="form-group">
            									<label class="col-sm-3 control-label placasVigentes"
            										for="placasVigentes"> Activo </label>
            									<div class="col-sm-9">
            										<input id="estatus" class="form-control" type="checkbox" <?php if($reglaDescuento->getEstatus()=='activo'){ echo 'checked="checked"'; } ?> <?php if($permisos_descuentos<8){ echo 'disabled="disabled"'; } ?> />
            									</div>
            								</div>                             
        										<div class="row">
