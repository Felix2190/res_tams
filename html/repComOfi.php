...
<head>
    ...
    <title>Reporte comparativo por oficina</title>
            ...
            <div id="content" class="clearfix">
                ...
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                            <h2><i class="fa fa-map-marker"></i> &nbsp; Reporte comparativo por oficina</h2>                 
                        </div> 
                    </div>
            	</header>
...
<!-- 											<header>Reporte</header> -->
											<div class="rt-table">
<div class='table-wrapper'><header>Reporte comparativo por oficina.</header> </div> <table class='table'>
					<thead>
  						<tr>
