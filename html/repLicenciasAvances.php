...
<head>
    ...
    <title>Reportes avance de licencias</title>
            ...
            <div id="content" class="clearfix">
                ...
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                            <h2><i class="fa fa-map-marker"></i> &nbsp; Reporte avance de licencias</h2>                 
                        </div> 
                    </div>
            	</header>
                    ...
                    <div class="row ext-raster">
                    	<div class="col-sm-12" >
                            <div class="spacer-20"></div>
											<div class="col-sm-6">
                                        		<label for="txtFechaIni"  class="txtFechaIni ">Fecha:</label>
                								<input type="text" name="txtFechaIni" id="txtFechaIni" class=" txtFechaIni" value="<?php echo $fechaini; ?>" />
                							</div> 
<!--                 							<div class="col-sm-3"> -->
<!--                                         		<label for="txtFechaFin" class="txtFechaFin">Hasta</label><br /> -->
<!--                 								<input type="text"  name="txtFechaFin" id="txtFechaFin" class="form-control txtFechaFin" value="" /> -->
<!--                 							</div> 											 -->
<!-- 											<div class="spacer-20"></div> -->
...
<!-- 											<header>Reporte</header> -->
											<div class="rt-table">
<div class='table-wrapper'><header> Reporte avance de licencias. </header> </div><table class='table'>
					<thead>
  						<tr>
