<?php	
	...
	$nav = 'reportes';
	$subnav = 'repLicenciasConstancias';  
            ...
            <div id="content" class="clearfix">
                ...
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                            <h2><i class="fa fa-map-marker"></i> &nbsp; Reporte Licencias Exportar SAT</h2>                 
                        </div> 
                    </div>
            	</header>
                ...
                <div class="window">  
                    <div class="row ext-raster">
                    	<div class="col-sm-12" >
                            	...
                            	<div class="col-sm-6">
                                   	<label for="txtCURP" class="txtCURP col-sm-6">CURP</label>
                					<input type="text"  name="txtCURP" id="txtCURP" class="col-sm-6 txtCURP" value="" maxlength="18"/>
                				</div> 	
                				<div class="spacer-5"></div> 
                													
									<div class="col-sm-6">
                                   	<label for="txtRFC" class="txtRFC col-sm-6">RFC</label>
                					<input type="text"  name="txtRFC" id="txtRFC" class="col-sm-6 txtRFC" value="" maxlength="13"/>
                				</div> 					
                					
                				<div class="spacer-5"></div>
																																	
									<div class="col-sm-6">
                                   	<label for="txtLicencia" class=" col-sm-6 txtLicencia">No. Licencia</label>
                					<input type="text"  name="txtLicencia" id="txtLicencia" class="col-sm-6 txtLicencia" value="" />
                				</div> 	
                				
                				<div class="spacer-5"></div>	
                				
<!--                 				<div class="col-sm-6"> -->
<!--                                     	<label for="txtGUID"  class="col-sm-6 txtGUID">GUID </label> -->
<!--                                     	<input type="text" name="txtGUID" id="txtGUID" class="col-sm-6 txtGUID" value="" /> -->
<!--                 					</div> -->
                					
                					<div class="col-sm-3">
											
												<label>&nbsp;</label><br />
												<button  class="btn btn-success btn-block" id="btnBuscar" name="btnBuscar">Buscar</button>
											</div>
...
<!-- 											<header>Reporte</header> -->
											<div class="rt-table">
											<div class='table-wrapper'><header> Resultados de la busqueda:</header> </div>
