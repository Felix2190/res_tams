...
<head>
    ...
    <title>Reportes Licencias vigentes</title>
            ...
            <div id="content" class="clearfix">
                ...
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                            <h2><i class="fa fa-map-marker"></i> &nbsp; Reporte Licencias vigentes</h2>                 
                        </div> 
                    </div>
            	</header>
...
<!-- 											<header>Reporte</header> -->
											<div class="rt-table">
<div class='table-wrapper'><header> Reporte de Licencias vigentes.</header> </div><table class='table'>
					<thead>
  						<tr>
