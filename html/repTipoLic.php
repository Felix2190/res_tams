...
<head>
    ...
    <title>Reportes tipo de licencia</title>
            ...
            <div id="content" class="clearfix">
                ...
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                            <h2><i class="fa fa-map-marker"></i> &nbsp; Reportes tipo de licencia</h2>                 
                        </div> 
                    </div>
            	</header>
...
<!-- 											<header>Reporte</header> -->
											<div class="rt-table">
											<div class='table-wrapper'><header>Reporte por tipos de licencia.</header> </div><table class='table'>
					<thead>
  						<tr>
