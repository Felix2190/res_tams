                 ...
                 <div class="window">  
                            ...
                            <!-- <div class="row"> -->
                            	<div class="col-sm-12">
									...
									<div class="widget">
                            			...
                            			<input type="hidden" id="IdAsignado_" value="<?php echo $objSession->getIdUser(); ?>" />
                            				...
                            				<div class="row ext-raster">
                            					<div class="col-sm-5">
                            						<div class="inner-padding">
		                                            	...
		                                            	<p class="text-muted"><i class="fa fa-suitcase text-muted"></i> <?php echo $puesto; ?></p>
		                                            	<div class="spacer-5"></div>
		                                            	<p class="text-muted"><i class="fa fa-sitemap text-muted"></i> <?php echo $empresa; ?></p>
		                                            	<div class="spacer-5"></div>
		                                            	<p class="text-muted"><i class="fa fa-map-marker text-muted"></i> <?php echo $ubicacion; ?></p>
		                                            	<div class="spacer-5"></div>
		                                            	<p class="text-muted"><i class="fa fa-clock-o text-muted"></i> <?php echo $fecha; ?> hrs</p>
                                                  <div class="spacer-5"></div>
                                                  <p class="text-muted"><i class="fa fa-calendar text-muted"></i> Fecha de resoluci&oacute;n:</p>
                                                  <div class="spacer-5"></div>
                                                  <p class="text-muted"><i class="fa fa-clock-o text-muted"></i> <?php echo $fecha_resolucion; ?></p>
                                                  <div class="spacer-5"></div>
                                                  <p class="text-muted">
					...
					<input type="hidden" name="txtEstatus" id="txtEstatus" value=""/>
										...
										<!-- Solo para el creador del ticket.  -->
  																<?php if($objSession->getIdUser() == $perfil): ?>
                                                ...
                                                <input type="hidden" id="txtAsignacion1" name="txtAsignacion1" value="<?php echo $perfil; ?>" />
													...
													<div id="contenedor_opciones_extra" style="display: none;">
														...
														<div class="col-sm-10">
                                                            ...
                                                            <input type="hidden" id="idPerfilActual" value="<?php echo $objSession->getIdUser(); ?>" />
                                                           <?php if ($objSession->getIdRol()>3){?> 
                                                            <select name="txtAsignacion" class="form-control " id="slcPersonal">
                                                            <option value="">Seleccione una opci&oacute;n</option>
		                                                    </select>
                                                           <?php } else {?>
                                                            <input type="hidden" id="slcPersonal" name="txtAsignacion" value="" />
