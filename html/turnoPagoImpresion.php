...
//	require 'admintickets.php';
	...
	$__pasoActual="pago";  //turno, tramite, pago, datos, documentos,verificacion, examen, impresion
            ...
            <div id="content" class="clearfix">
                ...
                <div class="window">
                    	...
                    	<div class="col-sm-12">
                            <div class="row">
                            	<div class="col-sm-12">
									...
									<div class="row">
										<div class="col-sm-12">
											<embed src="<?php echo $pdf?>" type="application/pdf" width="100%" height="500px" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html">
										</div>
									</div>
                  ...
                  <div class="spacer-50"></div>
                                    <div class="row">
                                    	<div class="col-sm-12"> 
                                        <div class="pull-right">                                                                                                                    <button type="submit" class="btn btn-success" onclick="sig()" >Siguiente</button>
<!--                                     		  <a href="biograficos.php?id=<?php echo $idTurnoActual;?>" class="btn btn-success">Siguiente</a> -->
                                        </div>                                        
                                    	</div>
                                    </div>
