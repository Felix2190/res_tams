...
<head>
    ...
    <title>Listado producto/servicio</title>
            ...
            <div id="content" class="clearfix">                
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                            <h2>Listado producto/servicio</h2>                 
                        </div> 
                    </div>
            	</header>                                     
                 <div class="window">  
                   	...
                   	<!-- <div class="col-sm-12"> -->
                            <!-- <div class="row"> -->
                            	<div class="col-sm-12">
								 ...
								 <form action="#" enctype="multipart/form-data" method="post" id="frmRegistro">
                                           <input id="archivo" accept=".csv" name="archivo" type="file" /> 
                                           <input name="MAX_FILE_SIZE" type="hidden" value="20000" />                                            
                                           <input type="submit" class="btn btn-success" name="btnGuardar" id="btnGuardar" value="Cargar" />
                                        </form>
                                        <div class="spacer-20"></div>
                                        <div class="col-sm-6 text-right">
														<label for="aviso" class="Aviso">La siguiete tabla muestra errores de la carga.</label>
										</div>
                                        <div class="client-block">
                  												<ul class="client-block-list">
                  													<li>
                  														<span class="label text-muted"><?php echo $insertados;?></span>														
                  													</li>
                  													<li>
                  														<span class="label text-muted"></span> <?php echo $noinsertados; ?>
                  													</li>
                  													<li>
                  														<span class="label text-muted"></span> <?php echo $totalRegistros; ?>
                  													</li>
                  												</ul>
                  											</div>                                        
