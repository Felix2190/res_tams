...
//	require 'admintickets.php';
  ...
  $rol = new ModeloRol();
  $recaudacion = new ModeloUbicacion();
  $usuario = new ModeloLogin_user();
  $usuario->setId_login($_POST['id']);    
?>
<!DOCTYPE html>
                          ...
                          <div class="inner-padding ">	
                            ...
                            <input type="hidden" value="<?php echo $_POST['id']; ?>" id="id" />          
            								<div class="form-group">
            									...
            									<div class="col-sm-9">
            										<input id="txtNombre" class="form-control" type="text" value="<?php echo $usuario->getFirst_name(); ?>"
            											maxlength="50" />
            									</div>
            								</div>
                            <div class="spacer-20"></div>
            								<div class="form-group">
            									<label class="col-sm-3 control-label txtApellidos"
            										for="txtApellidos"> Apellidos </label>
            									<div class="col-sm-9">
                                <input id="txtApellidos" class="form-control" type="text" value="<?php echo $usuario->getLast_name(); ?>" />
            									</div>
            								</div>                 
                            <div class="spacer-20"></div>           
            								<div class="form-group">
            									<label class="col-sm-3 control-label txtUsuario"
            										for="txtUsuario"> Usuario </label>
            									<div class="col-sm-9">
                                <input id="txtUsuario" class="form-control" type="text" value="<?php echo $usuario->getUser_name(); ?>" />
            									</div>
            								</div>     
                            <div class="spacer-20"></div>
            								<div class="form-group">
            									<label class="col-sm-3 control-label txtContrasena"
                            ...
                            <div class="spacer-20"></div>
            								<div class="form-group">
            									<label class="col-sm-3 control-label txtContrasenaRepetir"
            										for="txtContrasenaRepetir"> Repetir Contraseña </label>
            									<div class="col-sm-9">
                                <input id="txtContrasenaRepetir" class="form-control" type="password" />
            									</div>
            								</div>  
                            <div class="spacer-20"></div>
            								<div class="form-group">
            									<label class="col-sm-3 control-label txtEmail"
            										for="txtEmail"> Email </label>
            									<div class="col-sm-9">
                                <input id="txtEmail" class="form-control" type="text" value="<?php echo $usuario->getEmail(); ?>" />
            									</div>
            								</div> 
                            <div class="spacer-20"></div>
            								<div class="form-group">
            									...
            									<div class="col-sm-9">
                                <select id="slcRecaudacion" class="form-control"><?php echo $recaudacion->getListadoUbicacionSelect($usuario->getId_recaudacion()); ?></select>
            									</div>
            								</div> 
                            <div class="spacer-20"></div>
            								<div class="form-group">
            									<label class="col-sm-3 control-label slcRol"
            										for="slcRol"> Rol </label>
            									<div class="col-sm-9">
                                <select id="slcRol" class="form-control"><?php echo $rol->getListadoRolesSelect($usuario->getId_rol()); ?></select>
            									</div>
            								</div> 
                            <div class="spacer-20"></div>
            								<div class="form-group">
            									...
            									<div class="col-sm-9">
            										<input id="estatus" class="form-controles" type="checkbox" <?php if($usuario->getEstatus()=='activo'){ echo 'checked="checked"'; } ?> <?php if($permisos_usuarios<8){ echo 'disabled="disabled"'; } ?> />
            									</div>
            								</div>                             
        										<div class="row">
