...
<head>
    ...
    <title>Impresion de licencia #<?php echo $arrInfoLicencia['numero']?></title>
            ...
            <div id="content" class="clearfix">                
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                            <h2>Impresi&oacute;n de Licencia tipo <?php echo $arrInfoLicencia['tipoLicencia']?> No. <?php echo $arrInfoLicencia['numero']?></h2>                 
                        </div> 
                    </div>
            	</header>                                     
                 <div class="window">  
                   	...
                   	<!-- <div class="col-sm-12"> -->
                            <!-- <div class="row"> -->
                            			...
                            			<div>
                            				<div class="row ext-raster">
                            					<div class="col-sm-5">
                                                  ...
                                                  <div class="spacer-5"></div>
                                                  <p class="text-muted"><i class="fa fa-clock-o text-muted"></i> <?php echo $fechaExpira; ?></p>
                                                  
                                                  <div class="spacer-5"></div>
                                                  <p class="text-muted"><i class="fa fa-hand-o-up text-muted"></i> Huellas digitales: <i class="<?php echo $iconoHuella; ?>"></i> </p>
                                                  <div class="spacer-5"></div>
                                                  <p class="text-muted"><i class="fa fa-camera text-muted"></i> Fotograf&iacute;a: <i class="<?php echo $iconoFoto; ?>"></i> </p>
                                                  <div class="spacer-5"></div>
                                                  <p class="text-muted"><i class="fa fa-user text-muted"></i> Contacto emergencia: <i class="<?php echo $iconoContacto; ?>"></i> </p>
                                
                                                    <div class="spacer-5"></div>
                                                  <p class="text-muted"><i class="fa fa-map-marker text-muted"></i> Domicilio: <i class="<?php echo $iconoDomicilio; ?>"></i> </p>                                                  <div class="spacer-5"></div>
                              ...
                              <div class="spacer-20"></div>
								...
								<a href="javascript: imprimir(<?php echo $_SESSION['idLicencia'].','.($imprimir?'1':0)?>);"
											class="btn-square-icontext opciones enterado"> <i
											class="fa fa-print"></i>
											<p>Imprimir</p>
										</a>
										 
										<a href="listadoLicencias.php?estatus=pagada" class="btn-square-icontext">
