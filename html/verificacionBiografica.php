            ...
            <div id="content" class="clearfix">                
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                            <h2>Verificaci&oacute;n biogr&aacute;fica</h2>                 
                        </div> 
                    </div>
            	</header>                                     
                 <div class="window">
                   	...
                   	<!-- <div class="col-sm-12"> -->
                            <!-- <div class="row"> -->
                                ...
                                <div class="spacer-50"></div>
										...
										<div class="col-sm-12" style="display: none;" id="divCURP">
										...
										<div class="col-sm-3">
										<input type="button" onclick="validarCURP()" id="btnValidar" class="btn btn-primary" value="Validar"/>
