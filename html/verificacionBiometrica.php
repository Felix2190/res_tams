        ...
        <div id="main" class="clearfix">       
            ...
            <div id="content" class="clearfix">                
                <header id="header-sec"> 
                 ...
                 <div class="window">
                 <input type="hidden" id="hdnPermiso" name="hdnPermiso" value="<?php echo $permisos_turnos; ?>">  
                    <!-- <div class="row ext-raster"> -->
                   	<!-- <div class="col-sm-12"> -->
                            ...
                            <div class="spacer-50"></div>
										...
										<div class="col-sm-12" id="divBiom" style="display: none;">
										<input type="hidden" id="hdnIdVerBiom" value=""/>
										<input type="hidden" id="hdnEstatus" value=""/>
										<div class="widget">
                                                    <header>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Derecha</td>
                                            <td>Me&ntilde;ique</td>
                                            <td>
                                            <select id="slcOpcM" class="form-control">
                                            <option value="disponibleH">Disponible</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>Anular</td>
                                            <td>
                                            <select id="slcOpcA" class="form-control">
                                            <option value="disponibleH">Disponible</option>
                                            <option value="nodisponible">No disponible</option>
                                            <option value="dedovenda">Vendado</option>
                                            </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>Medio</td>
                                            <td>
                                            <select id="slcOpcE" class="form-control">
                                            <option value="disponibleH">Disponible</option>
                                            <option value="nodisponible">No disponible</option>
                                            <option value="dedovenda">Vendado</option>
                                            </select>
                                        ...
                                        <tr>
                                            ...
                                            <option value="dedovenda">Vendado</option>
                                								...
                                								<div id="verificaH"></div>
                                
                                <div class="spacer-50"></div> 
                                
                                <div class="col-sm-12 pull-rigth">
                                <div class="pull-right" id="divButtons">
                                	<a type="button" class="btn btn-warning" id="btnCancelar">Cancelar</a>
                                	<a type="button" class="btn btn-info" id="btnCapturar">Capturar</a>
                                </div>
                                </div>
