...
<head>
    ...
    <title>Ver turnos atendidos</title>
            ...
            <div id="content" class="clearfix">
                <header id="header-sec">
                	<div class="inner-padding">
                        <div class="pull-left">
                            <h2><i class="fa fa-list-ol"></i> &nbsp; Ver Atendidos</h2>
                        </div>
                    </div>
            	</header>
                 ...
                 <div class="window">
                    ...
                    <div class="inner-padding form-horizontal"> 
 								<div class="col-sm-3">	    
									<div class="panel panel-default">
									  <div class="panel-heading" style="background-color: lightblue;">
										<h3 class="panel-title">Modulo 1</h3>
									  </div>
								...
								<div class="col-sm-3">	
									<div class="panel panel-default">
									  <div class="panel-heading top" style="background-color: lightblue;" >
										<h3 class="panel-title">Modulo 2</h3>
									  </div>
									  <div class="panel-body">
										<h2>21</h2>
									  </div>
								...
								<div class="col-sm-3">	
									<div class="panel panel-default">
									  <div class="panel-heading top" style="background-color: lightblue;">
										<h3 class="panel-title">Modulo 3</h3>
									  </div>
									  <div class="panel-body">
										<h2>20</h2>
									  </div>
								...
								<div class="col-sm-3">	
									<div class="panel panel-default">
									  <div class="panel-heading top" style="background-color: lightblue;">
										<h3 class="panel-title">Modulo 4</h3>
									  </div>
									  <div class="panel-body">
										<h2>&nbsp</h2>
									  </div>
								...
								<div class="col-sm-6">	
									<div class="panel panel-default">
									  <div class="panel-heading top" style="background-color: lightgreen;">
										<h3 class="panel-title">Siguiente</h3>
									  </div>
									  <div class="panel-body">
										<h1>22</h1>
									  </div>
                        ...
                        <input type="button" id="btnActualizar" name="btnActualizar" value="Actualizar"  class="btn btn-default" />
                    </div>
                </div><!-- End .window -->
