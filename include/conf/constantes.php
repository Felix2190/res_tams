<?php
	...
	if(DEVELOPER)
	{
		...
		else
		{
			...
			define("DOMINIO","http://localhost/respaldo_tams/html/");
		}
	...
	if(DEVELOPER)
	{
		...
		define("CONFIGURACION_DBMS_DB","licenciastam");
	...
	else
	{
		...
		define("CONFIGURACION_DBMS","mysql");
		define("CONFIGURACION_DBMS_HOST","localhost");
		define("CONFIGURACION_DBMS_DB","motdmx_tamaulipas");
		define("CONFIGURACION_DBMS_USER","motdmx_root");
		define("CONFIGURACION_DBMS_PASS","123456789");
		define("CONFIGURACION_DBMS_PREFIX","");
  ...
  define("FOLDER_MODEL_BASE",FOLDER_MODEL . "base/");
	...
	define("FOLDER_JS",$_SERVER['DOCUMENT_ROOT'] . "/respaldo_tams/html/js/system/");
	...
	define("LIB_IMAGEN",FOLDER_LIB . "Imagen/php_image_magician.php");
	#-----------------------------------------------------------------------------------------------------------------------#
