...
// ESTILOS
	...
	function obtenQuery(){
		...
		$query="SELECT DISTINCT
	  		codigo,nombre,costoOrigen,costoFOBMXUS,CostoMXN,precioVenta	      FROM producto
	   ";
	...
	$titulos=array(utf8_encode("CÛdigo"),"Nombre",utf8_encode("Costo de origÈn"),"costo FOBMXUSD","Costo MXP","Precio de venta MXP");
	$indice=0;
	$objPHPExcel
	->getProperties()
	->setCreator("SPI")
