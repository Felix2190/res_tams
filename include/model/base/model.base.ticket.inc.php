<?php
	...
	class ModeloBaseTicket extends clsBasicCommon
	{
		...
		var $__s=array("id_ticket","id_solicitante","id_asignado","fecha","fecha_resolucion","id_tstatus","id_tipo","id_prioridad","titulo","notas");
		var $__ss=array();
		...
		protected function Insertar()
		{
			try
			{
				$SQL="INSERT INTO ticket(id_solicitante,id_asignado,fecha,fecha_resolucion,id_tstatus,id_tipo,id_prioridad,titulo,notas)
						VALUES('" . mysqli_real_escape_string($this->dbLink,$this->id_solicitante) . "','" . mysqli_real_escape_string($this->dbLink,$this->id_asignado) . "','" . mysqli_real_escape_string($this->dbLink,$this->fecha) . "','" . mysqli_real_escape_string($this->dbLink,$this->fecha_resolucion) . "','" . mysqli_real_escape_string($this->dbLink,$this->id_tstatus) . "','" . mysqli_real_escape_string($this->dbLink,$this->id_tipo) . "','" . mysqli_real_escape_string($this->dbLink,$this->id_prioridad) . "','" . mysqli_real_escape_string($this->dbLink,$this->titulo) . "','" . mysqli_real_escape_string($this->dbLink,$this->notas) . "')";
		...
		protected function Actualizar()
		{
			try
			{
				$SQL="UPDATE ticket SET id_solicitante='" . mysqli_real_escape_string($this->dbLink,$this->id_solicitante) . "',id_asignado='" . mysqli_real_escape_string($this->dbLink,$this->id_asignado) . "',fecha='" . mysqli_real_escape_string($this->dbLink,$this->fecha) . "',fecha_resolucion='" . mysqli_real_escape_string($this->dbLink,$this->fecha_resolucion) . "',id_tstatus='" . mysqli_real_escape_string($this->dbLink,$this->id_tstatus) . "',id_tipo='" . mysqli_real_escape_string($this->dbLink,$this->id_tipo) . "',id_prioridad='" . mysqli_real_escape_string($this->dbLink,$this->id_prioridad) . "',titulo='" . mysqli_real_escape_string($this->dbLink,$this->titulo) . "',notas='" . mysqli_real_escape_string($this->dbLink,$this->notas) . "'
		...
		public function getDatos()
		{
			...
			{
				$SQL="SELECT
						id_ticket,id_solicitante,id_asignado,fecha,fecha_resolucion,id_tstatus,id_tipo,id_prioridad,titulo,notas
					FROM ticket
					WHERE id_ticket=" . mysqli_real_escape_string($this->dbLink,$this->id_ticket);
