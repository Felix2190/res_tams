<?php
	...
	class ModeloBaseTicket_prioridad extends clsBasicCommon
	{
		...
		protected function Insertar()
		{
			try
			{
				$SQL="INSERT INTO ticket_prioridad(id_tprioridad,nombre,tag)
						VALUES('" . mysqli_real_escape_string($this->dbLink,$this->id_tprioridad) . "','" . mysqli_real_escape_string($this->dbLink,$this->nombre) . "','" . mysqli_real_escape_string($this->dbLink,$this->tag) . "')";
		...
		protected function Actualizar()
		{
			try
			{
				$SQL="UPDATE ticket_prioridad SET id_tprioridad='" . mysqli_real_escape_string($this->dbLink,$this->id_tprioridad) . "',nombre='" . mysqli_real_escape_string($this->dbLink,$this->nombre) . "',tag='" . mysqli_real_escape_string($this->dbLink,$this->tag) . "'
					WHERE =" . $this->;
