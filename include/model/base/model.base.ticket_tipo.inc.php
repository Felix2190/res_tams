<?php
	...
	class ModeloBaseTicket_tipo extends clsBasicCommon
	{
		...
		var $__s=array("id_ttipo","id_padre","nombre");
		var $__ss=array();
		...
		protected function Insertar()
		{
			try
			{
				$SQL="INSERT INTO ticket_tipo(id_padre,nombre)
						VALUES('" . mysqli_real_escape_string($this->dbLink,$this->id_padre) . "','" . mysqli_real_escape_string($this->dbLink,$this->nombre) . "')";
		...
		protected function Actualizar()
		{
			try
			{
				$SQL="UPDATE ticket_tipo SET id_padre='" . mysqli_real_escape_string($this->dbLink,$this->id_padre) . "',nombre='" . mysqli_real_escape_string($this->dbLink,$this->nombre) . "'
